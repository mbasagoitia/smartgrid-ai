...
Uses preprocessed weather and energy datasets to estimate long-term generator output, seasonal weather variance, transmission efficiency, and regional demand forecasts.

Optionally suggests the "optimal" placement per state and budget. Result is verified and refined with an LP solver that calculates the optimal generator placement given these constraints.
...
The total energy generated by all placed plants (accounting for weather variance and efficiency) is estimated by the AI service.
